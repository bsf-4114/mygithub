...
### 请求URL：
	http://localhost:3000/api/position/:geohash
...
### 请求URL：
	http://localhost:3000/api/index_category
...
### 请求URL：
	http://localhost:3000/api/search_shops
...
### 请求URL：
	http://localhost:3000/api/login_pwd
...
### 请求URL：
	http://localhost:3000/api/sendcode
...
### 请求URL：
	http://localhost:3000/api/login_sms
